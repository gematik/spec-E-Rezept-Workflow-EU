...
* insert MetaProfileExactly(https://gematik.de/fhir/erp-eu/{profile}, 1.5)
...
* insert MetaProfileSliceExactly(https://gematik.de/fhir/erp-eu/{profile}, 1.5, {field})
...
* insert MetaProfile(https://gematik.de/fhir/erp-eu/{profile}, 1.5)
...
* insert TargetProfile(https://gematik.de/fhir/erp-eu/{profile}, 1.5)
